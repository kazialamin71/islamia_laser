...
class report_detail_component(models.AbstractModel):
    ...
    def _get_report_values(self, docids, data=None):
        ...
        query="select b.name,b.grand_total,p.name,m.paid_amount,m.p_type from investigation_bill b,patient_info p, money_receipt m where p.id=b.patient_name and b.id=m.bill_id and b.create_date>= %s and b.create_date<=%s group by b.name,b.grand_total,p.name,m.paid_amount,m.p_type"
